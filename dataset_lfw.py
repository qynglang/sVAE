...
class LFW(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if os.path.exists('/nfs/h1/userhome/wdh-llx/workingdir/zsk/sVAE/Data/Face3/att/att/'+str(self.imgs[idx])[61:-3]+'npy'):
            label=np.load('/nfs/h1/userhome/wdh-llx/workingdir/zsk/sVAE/Data/Face3/att/att/'+str(self.imgs[idx])[61:-3]+'npy')
